...
var s_linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,doc,pdf,xls,hqx,dmg"
var s_linkInternalFilters="javascript:,macromedia,dreamweaver,flash,shockwave,sdc,markme,sdc.shockwave,infopoll,developerlocator.macromedia"
...
function s_doPlugins() {
	...
	s_vp_getCGI('s_prop3','refapp');
	s_vp_getCGI('s_prop4','riareqerr');
...
)+'://'+(s_ssl?'102':unc)+'.112.2O7.net/b/ss/'+un+'/1/G.6-Pd-S/'
